...
class AnpsGoogleMaps extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'AnpsGoogleMaps', esc_html__('AnpsThemes - Google Maps', 'anps_theme_plugin'), array('description' => esc_html__('Show Google Maps in sidebar and footer widget areas', 'anps_theme_plugin'),)
        );
    }
    
    public static function anps_register_widget() {
        return register_widget("AnpsGoogleMaps");
    }
    ...
    function form($instance) {
        ...
        <!-- Zoom -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('zoom')); ?>"><?php esc_html_e('Zoom', 'anps_theme_plugin'); ?></label>
        ...
        <!-- Height -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('height')); ?>"><?php esc_html_e('Height', 'anps_theme_plugin'); ?></label>
        ...
        <!-- Markers -->
        <label><?php esc_html_e('Markers', 'anps_theme_plugin'); ?></label>
        <div data-anps-repeat>
            ...
            <div class="anps-repeat-items" data-anps-repeat-items>
                ...
                <div class="anps-repeat-item" data-anps-repeat-item>
                    ...
                    <!-- Location -->
                    <p>
                        <label><?php esc_html_e('Location', 'anps_theme_plugin'); ?></label>
                        <input type="text" class="widefat" value="<?php echo esc_attr($location); ?>" />
                    </p>

                    <!-- Marker Image (URL) -->
                    <p>
                        <label><?php esc_html_e('Pin', 'anps_theme_plugin'); ?></label>
                        <input type="text" class="widefat" value="<?php echo esc_attr($pin); ?>" />
                    </p>

                    <!-- Info -->
                    <p>
                        <label><?php esc_html_e('Info', 'anps_theme_plugin'); ?></label>
...
add_action( 'widgets_init', array('AnpsGoogleMaps', 'anps_register_widget') );
