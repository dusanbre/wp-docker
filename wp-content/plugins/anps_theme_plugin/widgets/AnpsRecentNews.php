...
class AnpsRecentNews extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'anps-recent-posts', 'description' => esc_html__('Shows recent news', 'anps_theme_plugin'));
        parent::__construct('AnpsRecentNews', esc_html__('AnpsThemes - Recent News', 'anps_theme_plugin'), $widget_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title for recent news', 'anps_theme_plugin'); ?>: <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></label></p>

        <p><label for="<?php echo esc_attr($this->get_field_id('anps_number_fields')); ?>"><?php esc_html_e('Number of articles to show', 'anps_theme_plugin'); ?>:</label>
