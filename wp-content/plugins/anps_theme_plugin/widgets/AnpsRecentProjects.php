...
class AnpsRecentProjects extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'anps-recent-posts', 'description' => esc_html__('Shows recent projects', 'anps_theme_plugin'));
        parent::__construct('AnpsRecentProjects', esc_html__('AnpsThemes - Recent Projects', 'anps_theme_plugin'), $widget_ops);
    }
    ...
    function form($instance) {
        ...
        ?>
        <p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title for recent projects', 'anps_theme_plugin'); ?>: <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></label></p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id('anps_number_fields')); ?>"><?php esc_html_e('Number of projects to show', 'anps_theme_plugin'); ?>:</label>
