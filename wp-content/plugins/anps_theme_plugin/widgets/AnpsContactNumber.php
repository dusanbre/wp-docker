...
class AnpsContactNumber extends WP_Widget {
    public function __construct() {
        parent::__construct(
            'AnpsContactNumber', esc_html__('AnpsThemes - Contact Number', 'anps_theme_plugin'), array('description' => esc_html__('Display your contact number.', 'anps_theme_plugin'),)
        );
    ...
    function form($instance) {
        ...
        <!-- Text -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('text')); ?>"><?php esc_html_e("Text", 'anps_theme_plugin'); ?></label>
        ...
        <!-- Number -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e("Number", 'anps_theme_plugin'); ?></label>
        ...
        <!-- Number color -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number_color')); ?>"><?php esc_html_e("Number color", 'anps_theme_plugin'); ?></label><br />
